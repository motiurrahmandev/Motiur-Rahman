...
<div className="max-w-[1200px] mx-auto relative rounded-3xl overflow-hidden p-12 lg:p-20 text-center border border-primary/20 bg-gradient-to-b from-[#1b2721] to-[#111815]">
